...
#ifndef MULE_SCITE_SDKDIR
#define MULE_SCITE_SDKDIR "."
#endif
...
void SciTEBase::StartMuleTCM() {
	char sepc = '/';
	char asyncchar = '&';
	std::string postfixBin = "";
#ifdef _WIN32
	sepc = '\\';
	asyncchar = ' ';
	postfixBin = ".exe";
#endif
	std::string cmdtcm = std::string(MULE_SCITE_SDKDIR) + sepc + std::string("muletcm-qt") + postfixBin + std::string(" ") + asyncchar;
	std::system(cmdtcm.c_str());
	return;
}
